...
You can check for a file's layout, i.e. for it's lines' width and for the number 
of it's lines.
...
*cleanr* comes with to wrappers to check for file and function layout in one go:
...
```FALSE```. To completely disable all checks use:
```{r}
